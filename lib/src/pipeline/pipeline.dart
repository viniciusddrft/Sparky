...
final class Pipeline {
  final List<MiddlewareNullable> _mids = [];
  ...
  List<MiddlewareNullable> get mids => _mids;

  /// Adds a middleware function to the pipeline.
  ///
  /// The [middleware] parameter is a function that conforms to the `MiddlewareNullable` type.
  /// This function will be executed as part of the pipeline.
  void add(MiddlewareNullable middleware) => _mids.add(middleware);
}
